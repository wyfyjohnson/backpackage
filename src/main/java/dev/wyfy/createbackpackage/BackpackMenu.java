...
public class BackpackMenu extends AbstractContainerMenu {
  ...
  public BackpackMenu(int containerId, Inventory playerInventory) {
    this(containerId, playerInventory, new ItemStackHandler(BACKPACK_SIZE));
  }

  public BackpackMenu(int containerId, Inventory playerInventory, ItemStackHandler backpackInventory) {
    super(CreateBackpackage.BACKPACK_MENU.get(), containerId);
    this.backpackInventory = backpackInventory;

    // Setting up storage slot layouts
    ...
    // this.addSlot(new UpgradeSlot(upgradeInventory, 0, 152,36));
